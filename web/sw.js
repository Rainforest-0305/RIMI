...
const CACHE = 'miri-v27';   // v26→v27: 애널리스트 종가 표기에 기준일 병기('7/24 종가 249,500원' — 지표카드 라벨·차트 라벨·안내문구 3곳 통일, current_asof 기준·연도 다르면 YY/M/D). SHELL(index.html·shell.js) precache라 bump 필수(구셸 고착 방지)
