...
const CACHE = 'miri-v39';   // v38→v39: 하단 광고 1개 제거 + 인피드 4개(카드 5·10·15·20 뒤) — President 지시(2026-08-11).
                            //   광고 노드를 «떼지 않는» 제자리 교체(MIRI_ADS.setHTML)로 renderToday 재렌더에도 iframe 재로드 0.
                            //   ※ 고지문↔사업자정보 두 줄 간격 34px→12px 도 이 범프에 포함(①만 단독 커밋한다면 v38 로 낮출 것)
